...
def skim(tn, inf, outf, particle, nevents, cfg):
    ...
    cl_intv = ["cl3d_showerlength", "cl3d_coreshowerlength", "cl3d_firstlayer", "cl3d_maxlayer"]
    cl_floatv = [ "cl3d_energy", "cl3d_pt", "cl3d_eta", "cl3d_phi" ]
    cl_v = cl_uintv + cl_intv + cl_floatv
    ...
    # matching
    matchvars = ["deltaR", "matches"]#, "deta", "dphi", "layer"]
    ...
    floatv = gen_floatv + tc_floatv + cl_floatv #+ gen_floatv2
    for var in floatv:
